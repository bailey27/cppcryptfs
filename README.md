...
If you are not syncing the filesystem between two concurrently running instances of cppcryptfs or between and instance of cppcryptfs and gocryptfs, then there is no
