...
cppcryptfs is currently up-to-date with Dokany 1.0.0.5000.
...
You can choose between AES256-GCM or AES256-SIV (RFC 5297) for file data encryption.  The default is AES256-GCM which is recommended.
