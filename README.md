...
to open it as foo.txt, it will not be found.  However, on a normal Windows filesystem, it would be found.  This is not normally a problem because files are usually opened using the same case that was
