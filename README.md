...
to open it as foo.txt, it will not be found.  However, on a normal windows filesystem, it would be found.  This is not normally a problem because files are normally opened using using the same case of the letters that was
