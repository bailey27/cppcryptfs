...
current released version of OpenSSL (currently openssl-1.1.1c).  These are available from https://www.openssl.org/source/.  To use those, you will need to download
