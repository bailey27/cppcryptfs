...
The default (master) branch of cppcryptfs is for building with Dokany 1.0.0.  If you would like to build cppcryptfs with the current Dokany source, then after you clone cppcryptfs you need to switch to the current_dokany branch of cppcryptfs. 
